 ...
 */
public class ShareQueueTable extends Table implements TableOperateListener {
    ...
    public ShareQueueTable(Integer tableId, TableManagerForShareQueueTable tableManager, ProcessManager processManager) {
    ...
    private class AutoCallDealer implements Runnable {
        ...
        @Override
        public void run() {
            ShareQueueTable.this.callDealer(player, call, this.orderNo);
        }
    }
